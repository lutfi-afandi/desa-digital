...
class DevelopmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return  ResponseHelper::jsonResponse(true, 'Data Development berhasil diambil!', $developments, 200);
        } catch (\Exception $e) {
    ...
    public function store(DevelopmentStoreRequest $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Pembengunan berhasil dibuat!', new DevelopmentResource($development), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function show(string $id)
    {
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Pembangunan berhasil diambil!', $development, 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function update(DevelopmentUpdateRequest $request, string $id)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Pembengunan berhasil diupdate!', new DevelopmentResource($development), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            $this->developmentRepository->delete(
                $id
            );

            return ResponseHelper::jsonResponse(true, 'Data Pembengunan berhasil dihapus!', null, 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
